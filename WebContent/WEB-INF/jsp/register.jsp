...
<body>
	<div class="ibody">
       ...
       <form action="../user/register" method="post" id="registerForm" >
      		...
      		<tr>
      				<td>头&nbsp;&nbsp;像:</td>
      				<td class="pl_n"><dt><img name="headpic" src="../image_upload/6.jpg"/></dt></td>
      				<td><span></span><span></span></td>
      			</tr>
      			<tr>
      				<td  title="请输入用户名">用 户  名:</td>
      				<td ><input  name="name" class="loginInput" title="请输入用户名" aria-rule="^[\u4e00-\u9fa5A-Za-z0-9-_]{2,8}$" aria-err="用户名只能是2-8位中英文或数字或下划线"/></td>
      				<td><span></span><span></span></td>
      			</tr>
      			<tr>
      				<td>账&nbsp;&nbsp;号:</td>
      				<td ><input name="account" class="loginInput" aria-rule="^[a-zA-Z]\w{5,11}$" aria-err="账号以字母开头，长度在6-12位之间，只能包含字符、数字和下划线"/></td>
      				<td><span></span><span></span></td>
      			</tr>
      			<tr>
      				<td>密&nbsp;&nbsp;码:</td>
      				<td ><input name="password" class="loginInput" aria-rule="^[a-zA-Z]\w{5,9}$" aria-err="密码以字母开头，长度在6-10位之间，只能包含字符、数字和下划线"/></td>
      				<td><span></span><span></span></td>
      			</tr>
      			...
      			<tr>
      				...
      				<input name="contact" class="contactInput" aria-rule="" aria-err=""/></td>
      				<td><span></span><span></span></td>
      				<td></td>
      			</tr>
      			<tr>
